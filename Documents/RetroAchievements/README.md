...
| [43_RAディスクマウント状態機械再設計計画.md](43_RAディスクマウント状態機械再設計計画.md) | Drive 1 anchor限定、Hardcoreでの補助Drive hash所属検証、マルチイメージと媒体変更の再設計計画・実施結果 |
| [44_動作確認運用手順.md](44_動作確認運用手順.md) | 自動テスト、Codex実働GUIテスト、ユーザー手動受入の責任分界・手順・完了報告 |
